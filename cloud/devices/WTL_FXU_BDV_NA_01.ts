...
function structuredLabel(value: string) {
    ...
    if (value.startsWith('ERROR_')) return `오류 ${value.slice(6).replaceAll('_', ' ')}`
...
const COURSE_LABELS: DisplayLabels = {
    '3IN2_REF': '3 in 2 리프레시',
    ADD_PREWASH: '애벌세탁 추가',
    AIRCLEANING: '에어 클리닝',
    ALLERGY_SPASTEAM: '알레르기 스파 스팀',
    ALLERGYCARE: '알레르기 케어',
    ANSIMCOLD: '안심 냉수',
    BABY_STEAMCARE: '아기옷 스팀 케어',
    BABYCARE: '아기옷',
    BEDDING: '침구',
    BOIL: '삶음',
    BRIGHT_WHITE: '화이트 강화',
    ...
    SPA_REF: '스파 리프레시',
    SPEED_DRY: '급속 건조',
    SPEED_TUB_CLEAN: '급속 통살균',
    SPEEDWASH: '급속 세탁',
    SPEED14: '급속 14분',
    SPEEDBOIL: '급속 삶음',
    SPEEDWASH_DRY: '급속 세탁·건조',
    SPIN_ONLY: '탈수 단독',
    SPORTS_WEARS: '스포츠 의류',
    STAINCARE: '얼룩 케어',
    STEAM_COTTON: '스팀 면',
    ...
    WASHONLY: '세탁 단독',
    WHITE: '흰옷',
    WINDSPIN120: '바람 탈수 120분',
    WINDSPIN60: '바람 탈수 60분',
    WINDSPIN90: '바람 탈수 90분',
    WOOL: '울',
    SINGLE_SHIRTS: '셔츠 한 벌',
    MIXFABRIC: '혼합 의류',
    SPORTWEAR: '스포츠 의류',
    QUICKDRY: '급속 건조',
    RACKDRY: '선반 건조',
    ...
    CONDENSERCARE: '콘덴서 케어',
    TUBCLEAN: '드럼 케어',
    PADDINGREFRESH: '패딩 리프레시',
    TIMEDRY: '시간 건조',
    WATERREPELLENT: '발수 의류',
    BABYWEAR: '아기옷',
    SMALLLOAD: '소량',
    COTTONPLUS: '면 플러스',
    PERMPRESS: '구김 방지',
...
const DISPLAY_LABELS: DisplayLabels = {
    ...
    ...Object.fromEntries(
        [
            ...Object.values(WASHER_COURSES),
            ...Object.values(WASHER_ERRORS),
            ...
            ...Object.values(DRYER_COURSES),
            ...Object.values(DRYER_DRY_LEVELS),
            ...Object.values(DRYER_ERRORS),
            ...Object.values(DRYER_DUCT_CLOGGING),
...
export default class Device extends AABBDevice {
    ...
    constructor(HA: Connection, thinq: Thinq2Device, meta: Metadata) {
        ...
        this.setConfig(
            allowExtendedType({
                ...HADevice.config(meta, { name: '워시타워' }),
                components: {
                    washer_state: {
                        platform: 'sensor',
